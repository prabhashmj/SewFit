...
<table>
                    <thead>
                      <tr>
                        ...
                        <th data-field="name">NIC-side1</th>
                        <th data-field="name">NIC-side2</th>
                        ...
                        <th data-field="price">Voucher</th>
                      </tr>
                    </thead>
				...
				while($row = mysqli_fetch_array($result))
				{
                    ...
                    echo '  
                               ...
                               <td>  
                                    <img class="materialboxed" src="data:image/jpeg;base64,'.base64_encode($row['nic_photo'] ).'"  width="100" class="img-thumnail" />  
                               </td>  
                    ...
                    echo '  
                               ...
                               <td>  
                                    <img class="materialboxed" src="data:image/jpeg;base64,'.base64_encode($row['nic_photo2'] ).'"  width="100" class="img-thumnail" />  
                               </td>  
