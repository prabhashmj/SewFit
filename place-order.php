                ...
                <div class="card-panel">
                  <div class="row">
                    <form class="formValidate col s12 m12 l6" id="formValidate" method="post" action="confirm-order.php" novalidate="novalidate">
                      ...
                      <div class="row">
                          <p style="color: #001364;">If you have selected to pay using the voucher, you have to provide your card details for the payment. After we receive the voucher, the amount will be refunded to your account!</p>
                      ...
                      <div class="row">
                        <div class="input-field col s12">
                          <i class="mdi-communication-vpn-key prefix"></i>	
							...
							<label for="cvv_number" class="">CCV Number</label>
...
//            $measures_taken = $row['measurements'];
  ...
  <footer class="page-footer" style="background-color: #5a5a42;">
    ...
    $("#formValidate").validate({
        ...
        messages: {
           ...
           cvv_number:{
                required: "Please provide type number",
