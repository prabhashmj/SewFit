    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold active"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Clothing Items</a>
            </li>
                <li class="no-padding">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Clothing Items</h5>
              </div>
            </div>
          </div>
        </div>
		  ...
		  <form class="formValidate" id="formValidate" method="post" action="routers/menu-router.php" novalidate="novalidate">
            <div class="row">
              <div class="col s12 m4 l3">
                <h4 class="header">Order Uniform</h4>
              </div>
              <div>
				...
				while($row = mysqli_fetch_array($result))
				{
                    ...
                    echo '<td>';
//                    if($row['measurements'] == '5'){
//                        $text3 = 'selected';
//                        $text4 = '';
//                        $text5 = '';
//
//                    }
//                    else if($row['measurements'] == '2'){
//                        $text3 = '';
//                        $text4 = 'selected';
//                        $text5 = '';
//                    }
//                else if($row['measurements'] == "5,2"){
//                    $text3 = 'selected';
//                    $text4 = 'selected';
//                    $text5 = '';
//                }
//                else if($row['measurements'] == 3){
//                    $text3 = '';
//                    $text4 = '';
//                    $text5 = 'selected';
//                }
...
//                    $text5 = 'selected';
//                }
                   $text3 = $row['measurements'] ;
                    $text4 = $row['measurements'] ;
                    $text5 = $row['measurements'] ;
//                    if(is_numeric($text4)){
//                      echo '<pre>'.  print_r( $row['measurements'],1);
//                    }
//                    $text4 = str_replace("1","",$text4);
//                    $text4 = (int)$text4;
                    echo print_r($row['measurements'],1);
                    echo '<select  name="'.$row['id'].'_measurements[]" multiple >
                      <option selected disabled hidden>Please Select</option>
                      <option selected disabled hidden>Measures For a Shirt</option>

                      <option value="Full Shoulder"'.$text3.'>Full Shoulder</option>
                      <option value="Sleeves"'.$text4.'>Sleeves</option>
                      <option value="Chest"'.$text5.'>Chest</option>
                      <option value="Stomach"'.$text5.'>Stomach</option>
                      <option value="Shirt Length"'.$text5.'>Shirt Length</option>
                      <option value="Back Length"'.$text5.'>Back Length</option>
                      <option value="Vest"'.$text5.'>Vest</option>
                      <option value="Neck"'.$text5.'>Neck</option>
                      <option selected disabled hidden>Measures For a Trouser</option>
                      <option value="Waist"'.$text5.'>Waist</option>
                      <option value="Hips"'.$text5.'>Hips</option>
                      <option value="Crotch (U)"'.$text5.'>Crotch (U)</option>
                      <option value="Trouser Length"'.$text5.'>Trouser Length</option>
                      <option value="Cuff"'.$text5.'>Cuff</option>
                      <option value="Thigh"'.$text5.'>Thigh</option>
                      <option selected disabled hidden>Measures For a Frock</option>

                      <option value="Shoulder"'.$text5.'>Shoulder</option>
                      <option value="Sleeve length"'.$text5.'>Sleeve length</option>
                      <option value="Sleeve Circumference"'.$text5.'>Sleeve Circumference</option>
                      <option value="Arm hole"'.$text5.'>Arm hole</option>
                      <option value="Bust/Chest"'.$text5.'>Bust/Chest</option>
                      <option value="Waist"'.$text5.'>Waist</option>
                      <option value="Low Waist"'.$text5.'>Low Waist</option>
                      <option value="Shoulder to Waist"'.$text5.'>Shoulder to Waist</option>
                      <option value="Shoulder to low Waist"'.$text5.'>Shoulder to low Waist</option>
                      <option value="Full Length"'.$text5.'>Full Length</option>
...
<!--                --><?php
//                echo '<label>Please Select relevent Measurements : </label>
